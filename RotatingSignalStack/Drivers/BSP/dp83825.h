...
/** @defgroup DP83825
  ...
  */     
/* Exported constants --------------------------------------------------------*/
/** @defgroup DP83825_Exported_Constants DP83825 Exported Constants
  * @{
  */ 
...
/** @defgroup DP83825_Status DP83825 Status
  * @{
  */    
#define  DP83825_STATUS_READ_ERROR            ((int32_t)-5)
#define  DP83825_STATUS_WRITE_ERROR           ((int32_t)-4)
#define  DP83825_STATUS_ADDRESS_ERROR         ((int32_t)-3)
#define  DP83825_STATUS_RESET_TIMEOUT         ((int32_t)-2)
#define  DP83825_STATUS_ERROR                 ((int32_t)-1)
#define  DP83825_STATUS_OK                    ((int32_t) 0)
#define  DP83825_STATUS_LINK_DOWN             ((int32_t) 1)
#define  DP83825_STATUS_100MBITS_FULLDUPLEX   ((int32_t) 2)
#define  DP83825_STATUS_100MBITS_HALFDUPLEX   ((int32_t) 3)
#define  DP83825_STATUS_10MBITS_FULLDUPLEX    ((int32_t) 4)
#define  DP83825_STATUS_10MBITS_HALFDUPLEX    ((int32_t) 5)
#define  DP83825_STATUS_AUTONEGO_NOTDONE      ((int32_t) 6)
/**
  * @}
  */

/** @defgroup DP83825_IT_Flags DP83825 IT Flags
  * @{
  */  
// FINALLY A GEMINI W IT READ THE DATA SHEET CORRECTLY HOORAY 

// DP83825_REG_12 register interrupt control bits

/* --- Interrupt Status Bits (Type: RC - Read to Clear) --- */
#define DP83825_LINK_QUALITY_INTERRUPT               0x8000  /* interrupt for Link quality indication */
#define DP83825_ENERGY_DETECT_INTERRUPT              0x4000  /* interrupt for energy detect indication */
#define DP83825_LINK_INTERRUPT                       0x2000  /* interrupt for link status */
#define DP83825_SPEED_INTERRUPT                      0x1000  /* interrupt for speed status */
#define DP83825_DUPLEX_INTERRUPT                     0x0800  /* interrupt for duplex */
#define DP83825_AUTO_NEGOTIATION_COMPLETE_INTERRUPT  0x0400  /* interrupt for autonegotiation */
#define DP83825_FALSE_CARRIER_HALF_FULL_INTERRUPT    0x0200  /* interrupt for false carrier */
#define DP83825_RHF_INTERRUPT                        0x0100  /* interrupt for rhf */

/* --- Interrupt Enable Bits (Type: R/W - Read/Write) --- */
#define DP83825_LINK_QUALITY_INTERRUPT_ENABLE        0x0080  /* interrupt enable for Link quality indication */
#define DP83825_ENERGY_DETECT_INTERRUPT_ENABLE       0x0040  /* interrupt enable for energy detect indication */
#define DP83825_LINK_INTERRUPT_ENABLE                0x0020  /* interrupt enable for link status */
#define DP83825_SPEED_INTERRUPT_ENABLE               0x0010  /* interrupt enable for speed status */
#define DP83825_DUPLEX_INTERRUPT_ENABLE              0x0008  /* interrupt enable for duplex */
#define DP83825_AUTO_NEGOTIATION_COMPLETE_INT_ENABLE 0x0004  /* interrupt enable for autonegotiation */
#define DP83825_FALSE_CARRIER_HALF_FULL_INT_ENABLE   0x0002  /* interrupt enable for false carrier */
#define DP83825_RHF_INTERRUPT_ENABLE                 0x0001  /* interrupt enable for rhf */
/**
  * @}
  */
...
/* Exported types ------------------------------------------------------------*/ 
/** @defgroup DP83825_Exported_Types DP83825 Exported Types
  * @{
  */
typedef int32_t  (*DP83825_Init_Func) (void); 
typedef int32_t  (*DP83825_DeInit_Func) (void);
typedef int32_t  (*DP83825_ReadReg_Func)   (uint32_t, uint32_t, uint32_t *);
typedef int32_t  (*DP83825_WriteReg_Func)  (uint32_t, uint32_t, uint32_t);
typedef int32_t  (*DP83825_GetTick_Func)  (void);

typedef struct 
{                    
  DP83825_Init_Func      Init; 
  DP83825_DeInit_Func    DeInit;
  DP83825_WriteReg_Func  WriteReg;
  DP83825_ReadReg_Func   ReadReg; 
  DP83825_GetTick_Func   GetTick;   
} DP83825_IOCtx_t;  
...
/* Exported macro ------------------------------------------------------------*/
/* Exported functions --------------------------------------------------------*/
/** @defgroup DP83825_Exported_Functions DP83825 Exported Functions
  * @{
  */
...
int32_t DP83825_StartAutoNego(DP83825_Object_t *pObj);
